...
*/
const str = ['ciao', 'amici', 'miei']
const lunghezza = str.map((parole) => {
...
return movie.imdbID === 'tt4154796'
})
console.log(film)
/* ESERCIZIO 15 (findIndex)
  Scrivi una funzione per ottenere dall'array fornito l'indice del primo film uscito nell'anno fornito come parametro.
*/
const filmIndex = movies.findIndex((movie) => {
